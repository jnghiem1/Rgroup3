...
## Change columns name.  Need help in changing column names.  

group_project_data_nototal2 %>% rename(Consumer_FirstClass=Consumer, Consumer_SameDayClass=...3, Consumer_SecondClass=...4, ...5=Consumer_StandardClass, Corporate_FirstClass=Corporate, Corporate_SameDayClass=...8, Corporate_SecondClass...9, Corporate_StandardClass=...10, HomeOffice_FirstClass=`Home Office`, HomeOffice_SameDayClass=...13, HomeOffice_SecondClass=...14,HomeOffice_StandardClass= ...15)
