...
## Deletion of row 2 (Order ID). This row only contains the sub-name or column title for 1st column aka Segment. 

## Separate ORDER ID into three columns (Country, Year, Order ID)

## Deletion of Consumer Total, Corporate Total, and Home Office Total columns.  

## Gather or PIVOT-LONGER to combine segments: Consumer, Corporate, Home Office. 

## No mutation is needed.  NAs should be treated as zero or MAR.  
